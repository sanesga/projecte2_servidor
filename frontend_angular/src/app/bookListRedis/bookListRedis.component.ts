...
@Component({
  selector: 'app-bookListRedis-page',
  styleUrls: ['bookListRedis.component.css'],
  templateUrl: './bookListRedis.component.html'
})
export class BookListRedisComponent implements OnInit {
  book: Book;
